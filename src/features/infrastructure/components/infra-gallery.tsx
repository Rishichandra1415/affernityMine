...
interface InfraGalleryProps {
  images: string[];
}

export function InfraGallery({ images }: InfraGalleryProps) {
    ...
    <section className="bg-zinc-950 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Image
                ...
                alt={`Infrastructure gallery ${currentIndex + 1}`}
                fill
        ...
        <div className="mt-8 text-center text-sm font-medium uppercase tracking-widest text-zinc-500">
           Technical Facility Documentation
        </div>
      </div>
    </section>
  );
