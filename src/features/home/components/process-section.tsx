...
export function ProcessSection() {
  return (
    <section className="relative overflow-hidden bg-[#fafafa] py-10 sm:py-12 dark:bg-zinc-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header Section */}
        <div className="flex flex-col items-center text-center space-y-3 mb-8 lg:mb-10">
        ...
        {/* Infographic Grid */}
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-6 lg:gap-4 relative w-full max-w-[90rem] mx-auto">
