...
const footerData = {
  ...
  socials: [
    ...
    {
      label: "Facebook",
      href: "https://www.facebook.com/aaffinitysports",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/accounts/login/?next=https%3A%2F%2Fwww.instagram.com%2Faaffinitysports%2F&is_from_rle",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
